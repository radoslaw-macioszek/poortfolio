...
const salutTextContainer = document.querySelector(".home__text-container");
const salutImgContainer = document.querySelector(".home__img-container");
...
boxContainer.addEventListener("click", () => {
	document.location.href = "http://www.github.com/radoslaw-macioszek";
});
